...
export default function Home() {
    return (
        <>
            ...
            <p>
                <a href="https://www.linkedin.com/in/💻-pedro-marques-706710164"><u>  <Typewriter text="☞ Message me on LinkedIn" delay={PRIMARY_CONTENT_DELAY}></Typewriter> </u></a>
                <br /><a href="https://github.com/drokii"><u>  <Typewriter text="☞ Follow me on Github" delay={PRIMARY_CONTENT_DELAY}></Typewriter> </u></a>
            </p>
        </>
    )
}